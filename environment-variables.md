...
| BASE_URL           | The (accessible) hostname (and port) of the listening web server.   | http://locahost:5050  |
...
| MAY_2025_REBRAND_ENABLED   | Feature flag to enable the May 2025 GOV.UK branding changes                               | true           |
