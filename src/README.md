...
- HMP Form Wizard is a config based framework so unit tests are not required for the `fields.js` and `steps.js`, this integreation is more appropriately tested using [browser tests](../test/browser)
